...
/**
 * Write a description of class BetterBasket here. BetterBasket.java seeks to
 * aid user interface for each instance of basket: -several items of the same
 * type can be combined into one request of the same product. -insert a sorting
 * method on BetterBasket via product ID or sort via differing categories (i.e.
 * alphabetical, chronological, numerical, etc)
 * 
 * 
